...
[Step 1: e.g., "User connects their GitHub repository via OAuth"]
[Step 2: e.g., "The system ingests pipeline logs and feeds them to watsonx.ai"]
[Step 3: e.g., "An anomaly score is computed and displayed on the dashboard"]
[Step 4: e.g., "Alerts are sent to Slack when the score exceeds a threshold"]
